...
urlpatterns = [
    ...
    path('comment/list', views.CommentListView.as_view(), name='list_comment'),
    path('comment/<pk>', views.CommentView.as_view(), name='retrieve_comment'),
    path('comment/<pk>/update', views.CommentUpdateView.as_view(), name='update_comment'),
    path('comment/<pk>/delete', views.CommentDeleteView.as_view(), name='update_comment'),
]